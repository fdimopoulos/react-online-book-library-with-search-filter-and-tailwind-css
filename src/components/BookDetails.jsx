  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <div className=" dark:bg-slate-800 w-full">
        <div className="grid place-items-center grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8 min-h-[80vh] max-w-[1440px] mx-auto p-8 overflow-x-hidden ">
          ...
          <div className="col-span-2 flex flex-col gap-4 px-0 md:px-4 ">
            ...
            <div>
              ...
              <p className="text-gray-800 dark:text-whitish ">{book.authors}</p>
            </div>
            <div>
              <h3 className="text-blackish dark:text-white font-bold md:text-xl text-lg">
                Description
              </h3>
              <p className="text-gray-800 dark:text-whitish max-w-prose">
                {book.description}
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-800 dark:text-whitish ">{book.genres}</p>
            </div>
            <div>
              <h3 className="text-blackish dark:text-white font-bold md:text-xl text-lg">
                Pages
